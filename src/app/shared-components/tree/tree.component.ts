...
export class TreeComponent implements OnInit {
    ...
    update(source: any) {
        ...
        nodeEnter
            ...
            .attr('cx', 0)
            .attr('stroke', (d)=>{
                return d.data.isRoot==false? d.data.valueColor:'white';
            })
            .attr('stroke-width', 2)
            .style('fill', 'white');
            ...
            .html((d:any)=> {
                var str=`
                    <div style="width:${d.data.width}px;
                                height:${rectNode.height - rectNode.textMargin * 2}px;"> 
                                <p class="text-center mt-1" style="font-size:15px;">
                                    <span style="color:${d.data.titleColor};">${d.data.title}</span>
                                    <span class="text-capitalize" style="color:${d.data.valueColor};">${d.data.value}</span>
                                </p>
                    </div>
                `
                return str;
